...
const data: initialData = {
  ...
  results: [
    ...
    },
    {
      ...
      released: 2019,
      synopsis:
        "When the electromagnet super-powered hero known as, Static and his tech-savvy partner, Gear face off against the power-pulsing Boom, they also uncover a darker plan in the works by a most sinister of villains.",
    ...
    },
    {
      ...
      released: 2019,
      synopsis:
        "An ex drug dealer known by his street name D Stacks (Maurice McFadden) is on the quest to get revenge for the murders of his family. His best friend Q (Shawn Washington) is always by his ...",
      title: "EyeCon",
      type: "movie",
    },
    {
    ...
    },
    {
      ...
      released: 2019,
      synopsis:
        "'Muna' is the story of a spirited girl raised by her grandmother; the last surviving member of their family. Muna's driving desire to provide a better life for herself and grandmother in ...",
      title: "Muna",
      type: "movie",
    },
    {
    ...
    },
    {
      ...
      released: 2019,
      synopsis:
        "Emperor Palpatine dispatches a legion of imperial stormtroopers to the forest planet of Cilpar to retrieve a valuable asset.",
    ...
    },
    {
      ...
      released: 2019,
      synopsis:
        'Maks Fadeev, the young journalist, investigate the case "Forest of the dead sharks". He return to the forest for save the world, because evil became the invasion at the Earth.',
